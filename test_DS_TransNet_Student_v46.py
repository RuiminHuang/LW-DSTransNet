...
def parse_args():
    ...
    parser.add_argument('--weight_path', type=str, default="./logs/DS_TransNet_Student_v46_IRSTD_1k/train/20260420210514/best_miou.pth", help='weight for testing')# NUDT
