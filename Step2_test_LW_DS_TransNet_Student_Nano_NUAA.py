...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default="LW_DS_TransNet_Student_Nano_NUAA", help='experiment name')
    ...
    # testing parameters
    parser.add_argument('--weight_path', type=str, default="./logs/LW_DS_TransNet_Student_Nano_NUAA/train/20260420204250/best_miou.pth", help='weight for testing')# NUAA
