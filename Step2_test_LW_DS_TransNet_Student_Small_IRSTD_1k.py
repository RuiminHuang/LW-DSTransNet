...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default="LW_DS_TransNet_Student_Small_IRSTD_1k", help='experiment name')
    ...
    # testing parameters
    parser.add_argument('--weight_path', type=str, default="./logs/LW_DS_TransNet_Student_Small_IRSTD_1k/train/20260420210514/best_miou.pth", help='weight for testing')
