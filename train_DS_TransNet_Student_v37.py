...
from model.model import SC_TransNet_Github_Teacher, DS_TransNet_Student
...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default="DS_TransNet_Student_v37_NUDT", help='experiment name')
    ...
    parser.add_argument('--teacher_weight_path', type=str, default="./logs/DS_TransNet_Teacher_v37_NUDT/train/20260415105219/best_nIoU.pth", help='weight for testing')
...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        # teacher
        self.Teacher_net = SC_TransNet_Github_Teacher(mode='test')
        # weight init
        ...
        # student
        self.Student_net = DS_TransNet_Student(mode='train')
        # weight init 
        ...
        # Teacher hooks
        self.Teacher_net.model.inc.register_forward_hook( get_teacher_multi_output_activation('teacher_encoder_x1') )
        self.Teacher_net.model.down_encoder1.register_forward_hook( get_teacher_multi_output_activation('teacher_encoder_x2') )
        self.Teacher_net.model.down_encoder2.register_forward_hook( get_teacher_multi_output_activation('teacher_encoder_x3') )
        self.Teacher_net.model.down_encoder3.register_forward_hook( get_teacher_multi_output_activation('teacher_encoder_x4') )
