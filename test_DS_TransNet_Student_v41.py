...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default="DS_TransNet_Student_v41_NUAA", help='experiment name')
    ...
    # parser.add_argument('--weight_path', type=str, default="./logs/DS_TransNet_Student_v41_NUAA/train/20260420204250/best_nIoU.pth", help='weight for testing')# NUDT
    parser.add_argument('--weight_path', type=str, default="./logs/DS_TransNet_Student_v41_NUAA/train/20260420204250/best_miou.pth", help='weight for testing')# NUDT
