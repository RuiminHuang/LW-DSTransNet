...
from model.model import DS_TransNet_Teacher, DS_TransNet_Student
...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default="LW_DS_TransNet_Student_Nano_NUDT", help='experiment name')
