...
def parse_args():
    ...
    # testing parameters
    parser.add_argument('--weight_path', type=str, default="./logs/LW_DS_TransNet_Student_Small_NUDT/train/20260414215336/best_nIoU.pth", help='weight for testing')# NUDT
