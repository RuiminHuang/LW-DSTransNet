...
def parse_args():
    ...
    # testing parameters
    parser.add_argument('--weight_path', type=str, default="./logs/LW_DS_TransNet_Student_Small_NUAA/train/20260420205053/best_miou.pth", help='weight for testing')# NUAA
