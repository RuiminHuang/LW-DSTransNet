...
def parse_args():
    ...
    parser.add_argument('--weight_path', type=str, default="./logs/DS_TransNet_Student_v4_NUDT/train/20260330154601/best_nIoU.pth", help='weight for testing')# NUDT 0.8732
